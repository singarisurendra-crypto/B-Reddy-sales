    ...
    return <>
      ...
      <div className="report-layout">
        <aside className="report-sidebar">
          <div className="report-sidebar-title">Reports</div>
          <div className="report-sidebar-list">
            {reportOptions.map(r =>
              <button key={r.id} type="button"
                ...
                <span className="report-side-label">{r.label.replace(" Report","")}</span>
              </button>
            )}
          </div>
        </aside>
        ...
        <main className="report-content">
          <div className="panel report-filter-panel">
            <div className="report-filter-head">
              <div>
                <h3>{reportOptions.find(r=>r.id===reportTab)?.label||"Report"}</h3>
                <small>Use the filters below to view the selected report.</small>
              </div>
            ...
            <div className="report-filter-grid">
              ...
              <label className="report-search-field">Search<input placeholder={reportTab==="collections"?"Collection no. / customer":reportTab==="stock"?"Item / master":"Invoice no. / customer"} value={reportSearch} onChange={e=>setReportSearch(e.target.value)}/></label>
            </div>
          </div>
